...
export function ThreadView({ interrupt }: ThreadViewProps) {
  ...
  return (
    <div className="bg-muted/40 flex h-full w-full flex-col rounded-2xl p-8 lg:flex-row">
      {showSidePanel ? (
        <StateView
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      idx === activeInterruptIndex
                        ...
                        : "border-border text-muted-foreground bg-background hover:border-primary hover:text-primary",
                    )}
                  >
                    {title}
                  </button>
